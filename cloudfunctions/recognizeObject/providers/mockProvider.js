/**
 * Mock Provider - 云函数端 Mock AI 识别
 * 不依赖 miniprogram/utils/mockVision.js，独立实现
 */
...
/**
 * 根据图片路径做稳定 hash，返回对应词条
 */
function getStableWord(imagePath) {
  if (!imagePath) return randomWord();
...
module.exports = { getStableWord, randomWord, getAllWords };